...
function FAQItem({ question, answer, index }) {
  ...
  return (
    <motion.div
      ...
      className={`group rounded-lg border-[0.5px] border-gray-200/50 dark:border-gray-800/50 transition-all duration-200 ease-in-out ${
        isOpen
    ...
    >
      ...
      >
        <h3
          className={`text-base font-medium transition-colors duration-200 text-left text-gray-700 dark:text-gray-300 ${
        ...
        <motion.div
          ...
          className={`p-0.5 rounded-full shrink-0 transition-colors duration-200 ${
